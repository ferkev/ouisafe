...
export default class AlertB extends React.Component {
  ...
  render() {
    return (
      ...
      <Text>Bonjour je suis {this.state.person[0].FirstName} {this.state.person[0].LastName} je te contacte car j'ai un problème de santé et j'ai besoin d'aide, voici l'endroit où je me trouve actuellement.</Text>
        </View>
      </View>
    );
  }
